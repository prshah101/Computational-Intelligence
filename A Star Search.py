...
class Node:
    ...
    def expand(self, problem):#expansion
        """List the nodes reachable in one step from this node."""
        return [self.child_node(problem, action)
                for action in problem.actions(self.state)]

    def child_node(self, problem, action):#generation
    ...
    def __hash__(self):
        return hash(self.state)#quickly find the infor/comparison
...
class Graph:
    ...
    def __init__(self, graph_dict=None, directed=True):
        self.graph_dict = graph_dict or {} #ensures that graph_dict will always be a dictionary, even if it is undefined or empty.
...
# Define the local map as an undirected graph with distances in km
...
# Define the locations of each suburb in the locality
